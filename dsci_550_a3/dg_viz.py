...
def haunted_place_textbox(row, primary_tag, additional_tags, separator="|"):
    """
...
def hp_interactive_globe(hp_df, route_df, airport_df, coloring, additional_tags = None, airport_visibility = []):
...
def hp_interactive_darkmatter(hp_df, route_df, airport_df, legend_arg, additional_tags = None, airport_visibility = []):
    ...
    fig.update_layout(
        ...
        mapbox_center = dict(lat=38, lon = 75),
        font=dict(
